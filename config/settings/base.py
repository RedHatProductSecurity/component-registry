...
# if you set below to more than 14400 seconds, you must also update the redis visibility timeout
CELERY_LONGEST_SOFT_TIME_LIMIT = 14400
# Expire locks after 4 hours, which is the longest task time limit.

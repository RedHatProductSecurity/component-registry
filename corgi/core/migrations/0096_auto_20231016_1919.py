...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "CREATE INDEX IF NOT EXISTS compons_search_name ON core_component USING gin (name gin_trgm_ops);"
        ),
        migrations.RunSQL(
            "CREATE INDEX IF NOT EXISTS compons_search_purl ON core_component USING gin (purl gin_trgm_ops);"
        ),
    ]
